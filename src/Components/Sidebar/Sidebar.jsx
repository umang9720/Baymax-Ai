...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="side-bar sm:hidden lg:block" style={{ background: "#5497fa" }}>
        <div
          className={`${
            menu ? "w-18" : "effect"
        ...
        >
          <div className="flex flex-col gap-10 p-2">
            ...
            <div
                ...
                style={{
                  background: "rgb(167,192,255)",
                  fontWeight: "bold" // Apply bold font weight directly
                }}
                onClick={handleclear}
            >
              <GoPlus
