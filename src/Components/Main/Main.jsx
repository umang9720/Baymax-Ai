  ...
  return (
    <>
    {
      ...
      <div className="lg:w-screen sm:w-screen  flex flex-col items-center  overflow-y-scroll scroll-smooth"> 
        <div className="h-screen bg-teak  flex flex-col justify-between">

          <div className="lg:w-10/12  h-10 bg-teak flex justify-between items-center p-2 z-20">
            ...
            <div className="middle-part w-12/12 sm:gap-10  flex flex-col items-center p-3">
              ...
              <div className="cards w-12/12 h-72 z-12 flex justify-center gap-1 items-end sm:flex-wrap">
                ...
                >
                  ...
                  <div className="w-10 h-10 bg-teak rounded-full flex justify-center items-center absolute bottom-0 right-0 ">
          ...
          <motion.div className="w-12/12  bg-teak flex   items-center relative"
           animate={{x:[-2000,0]}}
