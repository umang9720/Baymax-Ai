...
const History = () => {
  ...
  return (
    <>
         ...
         <div className="lg:w-[50rem] sm:w-80 h-screen bg-teak  flex flex-col justify-between ">
         <div className="lg:w-10/12 sm:w-96 h-10 bg-teak flex justify-between items-center p-2">
         <div
              title="Collapse menu"
      ...
      <div className="w-12/12  bg-teak flex  items-center relative"
          >
            <input
              type="text"
              placeholder="Enter a prompt here"
              className="w-full  flex-1 outline-none h-16 ps-3 rounded-full"
              style={{ background: "#3a8af8" }}
              value={data}
